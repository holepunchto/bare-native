...
const { Color, Font, FontDescriptor } = UIKit
...
function paragraph(alignment) {
  ...
  if (resolved === undefined) {
    resolved = new UIKit.ParagraphStyle()
...
module.exports = class NativeText extends NativeTextNode {
  ...
  _apply() {
    const string = new UIKit.AttributedString()
    ...
    this._lineHeight = height === 0 ? Math.ceil(font(this._own).lineHeight) : height
