...
module.exports = exports = class NativeTextInputNode extends NativeControlNode {
  ...
  // Yoga insets a box's children by its padding and a field has none: what it
  // holds is a line the platform draws. So the padding is read back off the
  // pass that worked it out, and the platform insets the text by it.
  get _padding() {
    return {
