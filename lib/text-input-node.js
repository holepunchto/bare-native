...
module.exports = exports = class NativeTextInputNode extends NativeNode {
  ...
  // Whether the toolkit draws its own indication that this field has the
  // focus. Every platform that has one draws it by default, because a field
  // nobody can see the focus of is a field nobody can use without a mouse; an
