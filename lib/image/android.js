...
const { SCALE_TYPE } = NDK.ImageView
...
module.exports = class NativeImage extends NativeImageNode {
  constructor() {
    ...
    this._native = new NDK.ImageView()
  ...
  _decode(source) {
    const bitmap = source === null ? null : NDK.BitmapFactory.decodeFile(source)
    ...
    bitmap.density = NDK.DisplayMetrics.DENSITY_DEFAULT
