...
const { ALIGNMENT, SCALING } = AppKit.ImageView
...
module.exports = class NativeImage extends NativeImageNode {
  constructor() {
    ...
    this._native = new AppKit.ImageView({ x: 0, y: 0, width: 0, height: 0 })
  ...
  _decode(source) {
    const image = source === null ? null : AppKit.Image.withContentsOfFile(source)
