...
module.exports = class NativeSwitch extends NativeSwitchNode {
  ...
  // it a size on every pass, so it is asked with that let go of. The box is put
  // back rather than left for `_place` to state again, because a pass that
  // measures a node does not always place it.
  _natural() {
