...
const { INPUT_PURPOSE, INPUT_HINTS } = GTK.Entry

const { WRAP_WORD_CHAR } = GTK.constants
...
module.exports = class NativeTextInput extends NativeTextInputNode {
  constructor(opts) {
    ...
    this._focusing = new GTK.EventControllerFocus()
