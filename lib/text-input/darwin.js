...
const { Color, Font, FontDescriptor, View } = AppKit
...
module.exports = class NativeTextInput extends NativeTextInputNode {
  constructor(opts) {
    ...
    // so the ring is asked for rather than inherited.
    this._native.focusRingType = View.FOCUS_RING_TYPE.EXTERIOR
  ...
  _ringed(ring) {
    this._native.focusRingType = ring
      ? View.FOCUS_RING_TYPE.EXTERIOR
      : View.FOCUS_RING_TYPE.NONE
  }
